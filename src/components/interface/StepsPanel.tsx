...
function StepItem({
  ...
  const studyNavigateTo = () => (participantView ? (participantId ? navigate(`/${studyId}/${participantId}/${encryptIndex(stepIndex)}/`) : navigate(`/${studyId}/${encryptIndex(stepIndex)}`)) : navigate(`/${studyId}/reviewer-${step}`));
