...
export abstract class StorageEngine {
  ...
  abstract rejectParticipant(participantID: string, reason: string): Promise<void>;
...
export abstract class ServerStorageEngine extends StorageEngine {
  protected abstract _getFromStorage<T extends StorageObjectType>(prefix: string, type: T, studyId?: string, cache?: boolean): Promise<StorageObject<T> | null>;
