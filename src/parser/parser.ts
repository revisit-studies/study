...
function validateGlobalConfig(obj: unknown): obj is GlobalConfig {
  ...
  const configsListVerified =
    Object.hasOwn(obj as object, 'configsList') &&
  ...
  const configsVerified =
    Object.hasOwn(obj as object, 'configs') &&
    (obj as GlobalConfig).configs instanceof Object &&
    Object.entries((obj as GlobalConfig).configs).every(
      ([key, value]) =>
        typeof key === 'string' &&
  ...
  return [basicVerified, configsListVerified, configsVerified].every(
    (item, index) => {
      if (!item) {
...
function validateStudyMetadata(obj: unknown): obj is StudyMetadata {
  ...
  // Check type for date
  const dateVerified =
    Object.hasOwn(obj as object, 'date') &&
  ...
  const organizationVerified = Object.hasOwn(obj as object, 'organization')
    ? typeof (obj as StudyMetadata).organization === 'object' &&
      ...
      (obj as StudyMetadata).organization!.every(
...
function validateUiConfig(obj: unknown): obj is UIConfig {
  ...
  const contactEmailVerified =
    Object.hasOwn(obj as object, 'contactEmail') &&
  ...
  const sidebarVerified =
    Object.hasOwn(obj as object, 'sidebar') &&
    typeof (obj as UIConfig).sidebar === 'boolean';

  const steps = [
    'basicVerified',
    'contactEmailVerified',
    'helpTextPathVerified',
    'logoPathVerified',
    'withProgressBarVerified',
    'autoDownloadStudyVerified',
    'autoDownloadTimeVerified',
    'sidebarVerified',
  ];
  return [
    basicVerified,
...
function validateResponse(obj: unknown): obj is Response {
  ...
  const promptVerified =
    Object.hasOwn(obj as object, 'prompt') &&
...
function validateAnswer(obj: unknown): obj is Answer {
  ...
  const steps = [
    ...
    'idVerified',
    'answerVerified',
    'acceptableLowVerified',
    'acceptableHighVerified',
    'answerCallbackVerified',
    'answerRegexVerified',
  ];
  return [
    basicVerified,
