  ...
  describe('getResponseStats', () => {
    describe('basic functionality', () => {
        ...
        const studyConfig = makeConfig({
          components: {
            ...
            survey: {
              ...
              response: [
                {
                  id: 'q1', type: 'radio', prompt: 'Q1', options: ['A', 'B'],
                },
              ],
            },
          },
      ...
      it('should include correctness for each response', () => {
        ...
        const result = getResponseStats(participants, studyConfig, { 'config-hash-1': studyConfig });
    ...
    describe('edge cases', () => {
      ...
      it('should call studyComponentToIndividualComponent for each component', () => {
        const studyConfig = makeConfig({
          components: {
            comp1: { type: 'questionnaire', response: [{ id: 'q1', type: 'shortText', prompt: 'Q1' }] },
            comp2: { type: 'questionnaire', response: [{ id: 'q1', type: 'shortText', prompt: 'Q2' }] },
          },
        });
