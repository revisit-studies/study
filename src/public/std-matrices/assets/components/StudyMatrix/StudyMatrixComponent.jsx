...
import { setParameters } from "../../features/matrix/matrixSlice";
  ...
  return (
    <div id="buttons-div">
      ...
      >
        ...
        >
          <Button id="snr-optimal-clustering">
            Optimal Leaf Clustering (snr)
          </Button>
        ...
        >
          <Button id="std-optimal-clustering">
            Optimal Leaf Clustering (std)
          </Button>
