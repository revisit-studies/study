...
test('parser errors are shown correctly', async ({ page }) => {
  ...
  const errors = [
    ...
    'You have an error at /components/missingComponentFromLibrary: Base component $test.components.test-missing is not defined in baseComponents object - {"action":"add the base component to the baseComponents object"}',
