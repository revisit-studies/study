...
The original study provided equivalent 10-minute tutorials for both interfaces and allowed participants to keep a cheat sheet during the tasks.

## FFL

FFL rules use a selector and a declaration block:

```text
$y$ { color: crimson; label: target; }
$\\beta_*$ { color: mediumpurple; label: slope terms; }
```
